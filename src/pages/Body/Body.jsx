...
import { ModifyQuest } from '../ModifyQuest/ModifyQuest'
...
import { ModifySession } from '../ModifySession/ModifySession'
    ...
    return (
        <Container className='bodyDesign'>
            <Routes>
                ...
                <Route path='/quests/modify-quest' element={<ModifyQuest/>}/>
                ...
                <Route path='/sessions/modify-session' element={<ModifySession/>}/>
            </Routes>
        </Container>
    )
}
